...
def deploy(img_path):
    MODEL_JOB_DIR='/dli/data/digits/20181026-155602-189d'
    ...
    net = caffe.Classifier(ARCHITECTURE, WEIGHTS, channel_swap=(2,1,0),raw_scale=255,image_dims=(256, 256))              
    ...
    DATA_JOB_DIR ='/dli/data/digits/20181026-155530-4658'
